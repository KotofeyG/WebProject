...
public interface MenuService {
    ...
    List<Meal> findAvailableMealsForMenu(long menuId, int page) throws ServiceException;

    int getAvailableMealCountForMenu(long menuId) throws ServiceException;
    ...
    boolean updateMenuTitle(String menuIdStr, String title) throws ServiceException;
