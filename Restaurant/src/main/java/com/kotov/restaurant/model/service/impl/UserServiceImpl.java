...
public class UserServiceImpl implements UserService {
    ...
    @Override
    public User.Status findUserStatusById(long id) throws ServiceException {
        try {
            return userDao.findUserStatusById(id);
        } catch (DaoException e) {
            logger.log(Level.ERROR, "Impossible to find user status:", e);
            throw new ServiceException("Impossible to find user status:", e);
        }
    }
    ...
    @Override
    public boolean deleteUserAddress(long userId, String addressIdStr) throws ServiceException {
        boolean result = false;
        try {
            long addressId = Long.parseLong(addressIdStr);
            result = userDao.deleteUserAddress(userId, addressId);
        } catch (DaoException e) {
            logger.log(Level.ERROR, "Impossible to delete address from user:", e);
            throw new ServiceException("Impossible to delete address from user:", e);
        } catch (NumberFormatException e) {
            logger.log(Level.WARN, "String addressIdStr does not contain a parsable long: " + addressIdStr);
        }
        return result;
    }
    ...
    public boolean insertUserAddress(long userId, Map<String, String> dataCheckResult) throws ServiceException {
        boolean result = false;
        Optional<Address> optionalAddress = createAddress(dataCheckResult);
    ...
    Optional<Address> createAddress(Map<String, String> dataCheckResult) {
        ...
        if (result) {
            Address.City enumCity = Address.City.valueOf(city.toUpperCase());
            ...
            logger.log(Level.DEBUG, "Address data is invalid");
        }
