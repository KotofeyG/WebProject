        ...
        <form id="menu-form" method="post" action="${abs}/controller">
            ...
            <table class="table-bordered meal-table">
                ...
                <tr>
                    ...
                    <td colspan="2">
                        <input type="text" id="menu-title" class="form-control" name="title"
                    ...
                    <td colspan="2">
                        <button type="submit" form="menu-form"
                                class="btn btn-success form-group">${menu_creation}</button>
                    </td>
                </tr>
                <tr>
                    <th>${choice}</th>
            ...
            <table class="table-bordered meal-table">
                ...
                <c:forEach items="${meals}" var="order">
                    <tr>
                        ...
                        <td>${order.id}</td>
                        <td>${order.title}</td>
                        <td><img src="${order.image}" class="img-thumbnail" alt="${empty_picture}"
                                 width="153px"/></td>
